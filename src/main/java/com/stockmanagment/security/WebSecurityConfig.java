package com.stockmanagment.security;
...
import com.stockmanagment.security.jwt.JwtAuthEntryPoint;
import com.stockmanagment.security.jwt.JwtAuthTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().
                authorizeRequests()
                .antMatchers("/auth/**","/swagger-ui.html","/getProductList","/getProductListByTags/**","/files/**","/test/**").permitAll()
